...
<h2 class="has-text-align-center h1 is-style-no-vertical-margin has-body-background-color has-text-color">Lorem Ipsum</h2>
<!-- /wp:heading -->
...
<!-- wp:separator {"color":"accent","className":"is-style-no-vertical-margin"} -->
<hr class="wp-block-separator has-text-color has-background has-accent-background-color has-accent-color is-style-no-vertical-margin"/>
<!-- /wp:separator -->
...
<h2 class="has-text-align-center is-style-no-vertical-margin has-secondary-color has-text-color">Dolor Sit Amet</h2>
<!-- /wp:heading -->
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/default-fallback-image.png" alt="" class=""/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->

<!-- wp:column {"verticalAlignment":"bottom"} -->
<div class="wp-block-column is-vertically-aligned-bottom"><!-- wp:group -->
<div class="wp-block-group"><div class="wp-block-group__inner-container"><!-- wp:spacer {"height":16} -->
